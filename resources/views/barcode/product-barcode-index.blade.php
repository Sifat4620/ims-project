    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-header bg-light d-flex flex-wrap justify-content-between align-items-center gap-3 p-3">
            ...
            <form method="GET" action="{{ route('barcode.index') }}" class="d-flex gap-2 align-items-center m-0">
                ...
                <button type="submit" class="btn btn-sm btn-primary shadow-sm" aria-label="Search items">
            ...
            <div class="table-responsive shadow-sm">
                <table class="table table-hover align-middle">
                    <thead class="table-secondary">
                        <tr class="text-muted">
                            <th><input type="checkbox" id="selectAll" class="form-check-input" onclick="toggleAllCheckboxes(this)" aria-label="Select all items"></th>
                            <th>S.L</th>
                            <th>LC/PO Type</th>
                            <th>Brand</th>
                            <th>Category</th>
                    ...
                    <tbody>
                        @forelse ($items as $item)
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input item-checkbox" name="selected_items[]" value="{{ $item->id }}" aria-label="Select item {{ $item->id }}">
                                </td>
